export default {
  ...
  entry: {
    ...
    subtitleExpense: 'Record daily cash outlays',
    subtitleIncome: 'Record incoming funds and earnings',
    subtitleTransfer: 'Move money between accounts',
    subtitleEdit: 'Update existing record details',
    close: 'Close',
    ...
    sourceWallet: 'Source Account',
    targetWallet: 'Destination Account',
    selectCategory: 'Select Category',
    adminFee: 'Fee: {amount}',
    walletPickerTitle: 'Select Account',
    sourceWalletTitle: 'Select Source Account',
    targetWalletTitle: 'Select Destination Account',
    categoryExpenseTitle: 'Select Expense Category',
    categoryIncomeTitle: 'Select Income Category',
    addCategory: 'Add',
    datePickerTitle: 'Select Transaction Date',
    tabRecentDays: 'Last 30 Days',
    tabCustomDate: 'Custom Date',
    applyDate: 'Apply Date',
    feePickerTitle: 'Transfer / Admin Fee',
    feePickerSubtitle: 'Transaction cost between accounts or banks',
    popularFeePresets: 'Popular Fee Presets',
    freeFee: 'Free ({amount})',
    customFeeNominal: 'Custom Fee',
    applyFee: 'Use This Fee',
    noteModalTitle: 'Transaction Notes',
    noteModalSubtitle: 'Add details or context for this transaction',
    noteInputPlaceholder: 'Write notes here (optional)...',
    clearNote: 'Delete Note',
    saveNote: 'Save Note',
  ...
  settings: {
    ...
    googleDrive: {
      ...
      errorPlayServices: 'Google Play Services is not available or needs updating on this device.',
      errorNetwork: 'Network issue. Please check your internet connection and try again.',
      errorGeneric: 'Failed to connect to Google Drive. Please try again later.',
      errorNotConnected: 'Please connect your Google Drive account first.',
      errorSessionExpired: 'Google Drive session expired. Please reconnect your account.',
      errorBackupFailed: 'Failed to create backup to Google Drive. Please try again.',
      errorRestoreFailed: 'Failed to restore database from Google Drive. Please try again.',
      errorLoadFailed: 'Failed to load backups list from Google Drive.',
      errorSignOut: 'Failed to disconnect Google account. Please try again.',
      backupSuccess: 'Backup saved to Google Drive successfully!',
      disconnectSuccess: 'Google Drive disconnected successfully.',
