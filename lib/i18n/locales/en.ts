export default {
  ...
  entry: {
    quickRecord: 'Quick Transaction',
    editRecord: 'Edit Transaction',
    ...
    yesterday: 'Yesterday',
    adminFee: 'Fee: {amount}',
    adminFeeZero: 'Fee: Rp 0',
    anomaly: 'Anomaly',
    normal: 'Normal',
    notePlaceholder: 'Note...',
    selectSourceWallet: 'Select Source Wallet',
    selectOriginWallet: 'Select Origin Wallet',
    ...
    selectDateTitle: 'Select Transaction Date',
    recentDaysTab: 'Last 30 Days',
    customDateTab: 'Custom Date',
    applyDate: 'Apply Date',
    feeTitle: 'Transfer Fee / Admin',
    feeSubtitle: 'Fee for transfers between wallets or banks',
    popularPresets: 'Popular Fee Presets',
    customFee: 'Custom Fee',
    applyFee: 'Save Fee',
    freeFee: 'Free (Rp 0)',
    noteTitle: 'Transaction Note',
    noteSubtitle: 'Add details or context for this transaction',
