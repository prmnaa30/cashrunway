export default {
  ...
  settings: {
    ...
    categories: {
      ...
      desc: 'Tambah, ubah, atau hapus kategori transaksi',
      countBadge: '{count} Kategori',
    },
    reminders: {
      dailyTitle: 'Pengingat Pencatatan Harian',
      dailyDesc: 'Dapatkan pengingat rutin untuk mencatat pengeluaran setiap hari',
      activeSchedule: 'Jadwal Pengingat Aktif:',
      noSchedule: 'Tidak ada jadwal yang aktif saat ini.',
      manageButton: 'Kelola Jam Pengingat',
      testButton: 'Uji Coba Suara',
      testSuccess: 'Notifikasi dikirim! Periksa status bar HP.',
      testError: 'Gagal mengirim notifikasi.',
      sheetTitle: 'Jadwal Pengingat Harian',
      sheetSubtitle: 'Atur jam alarm pengingat untuk mencatat pengeluaran',
      addTime: 'Tambah Jam Pengingat',
      save: 'Simpan Pengingat',
      cancel: 'Batal',
      timeLabel: 'Waktu (Jam : Menit)',
      nameLabel: 'Label Pengingat (Opsional)',
      namePlaceholder: 'Misal: Makan Siang, Review Malam',
      defaultLabel: 'Pengingat',
      emptyReminders: 'Belum ada jadwal pengingat. Tekan tombol di bawah untuk menambah.',
      deleteTitle: 'Hapus Jam Pengingat?',
      deleteDesc: 'Jam pengingat ini tidak akan berbunyi lagi.',
    },
    exportCsv: {
